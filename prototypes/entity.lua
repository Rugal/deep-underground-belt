...
deep_undergroundbelt.icon = "__deep-underground-belt__/graphics/icons/deep-underground-belt.png"
deep_undergroundbelt.structure.direction_in.sheet =
    {   
        filename = "__deep-underground-belt__/graphics/entity/deep-underground-belt-structure.png",
        priority = "extra-high",
        width = 96,
        height = 96,
        y = 96,
        hr_version =
        {
            filename = "__deep-underground-belt__/graphics/entity/hr-deep-underground-belt-structure.png",
            priority = "extra-high",
            width = 192,
            height = 192,
            y = 192,
...
deep_fast_undergroundbelt.icon = "__deep-underground-belt__/graphics/icons/deep-fast-underground-belt.png"
deep_fast_undergroundbelt.structure.direction_in.sheet =
    {
        filename = "__deep-underground-belt__/graphics/entity/deep-fast-underground-belt-structure.png",
        priority = "extra-high",
        width = 96,
        height = 96,
        y = 96,
        hr_version =
        {
            filename = "__deep-underground-belt__/graphics/entity/hr-deep-fast-underground-belt-structure.png",
            priority = "extra-high",
            width = 192,
            height = 192,
            y = 192,
...
deep_express_undergroundbelt.icon = "__deep-underground-belt__/graphics/icons/deep-express-underground-belt.png"
deep_express_undergroundbelt.structure.direction_in.sheet =
    {
        filename = "__deep-underground-belt__/graphics/entity/deep-express-underground-belt-structure.png",
        priority = "extra-high",
        width = 96,
        height = 96,
        y = 96,
        hr_version =
        {
            filename = "__deep-underground-belt__/graphics/entity/hr-deep-express-underground-belt-structure.png",
            priority = "extra-high",
            width = 192,
            height = 192,
            y = 192,
